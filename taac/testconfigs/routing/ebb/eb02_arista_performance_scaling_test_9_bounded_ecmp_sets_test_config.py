...
# pyre-unsafe
"""EB02-ARISTA_PERFORMANCE_SCALING_TEST_9_BOUNDED_ECMP_SETS — EBB B17 TestConfig.

Built from the centralized
`test_config_for_bgp_plus_plus_on_ebb_arista_bounded_ecmp_sets` factory.
"""
...
EB02_ARISTA_PERFORMANCE_SCALING_TEST_9_BOUNDED_ECMP_SETS_TEST_CONFIG = (
    test_config_for_bgp_plus_plus_on_ebb_arista_bounded_ecmp_sets(
        test_config_name="EB02-ARISTA_PERFORMANCE_SCALING_TEST_9_BOUNDED_ECMP_SETS",
        host_driver_args={
        ...
        ebgp_peer_count_v6=128,
        ibgp_peer_count_v6=128,
        ebgp_peer_count_v4=128,
        ibgp_peer_count_v4=128,
