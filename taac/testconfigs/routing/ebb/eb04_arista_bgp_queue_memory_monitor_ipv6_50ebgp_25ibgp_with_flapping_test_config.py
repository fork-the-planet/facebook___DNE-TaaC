...
# pyre-unsafe
"""EB04_ARISTA_BGP_QUEUE_MEMORY_MONITOR_IPV6_50EBGP_25IBGP_WITH_FLAPPING — EBB B17 TestConfig.
...
EB04_ARISTA_BGP_QUEUE_MEMORY_MONITOR_IPV6_50EBGP_25IBGP_WITH_FLAPPING_TEST_CONFIG = test_config_bgp_queue_memory_monitoring_with_route_scale(
    test_config_name="EB04_ARISTA_BGP_QUEUE_MEMORY_MONITOR_IPV6_50EBGP_25IBGP_WITH_FLAPPING",
    ...
    direct_ixia_connections=[
        ...
        taac_types.DirectIxiaConnection(
            interface="Ethernet3/1/1",  # EBGP interface (with flapping routes)
            ixia_chassis_ip="2401:db00:2066:303b::3001",
            ixia_port="6/7",
        ),
    ],
