...
# pyre-unsafe
"""EB02-ARISTA_PERFORMANCE_SCALING_TEST_1_1000_IBGP_PEERS — EBB B17 TestConfig.

Built from the centralized
`test_config_for_bgp_plus_plus_on_ebb_arista_performance_scaling` factory.
"""
...
EB02_ARISTA_PERFORMANCE_SCALING_TEST_1_1000_IBGP_PEERS_TEST_CONFIG = (
    test_config_for_bgp_plus_plus_on_ebb_arista_performance_scaling(
        test_config_name="EB02-ARISTA_PERFORMANCE_SCALING_TEST_1_1000_IBGP_PEERS",
        host_driver_args={
