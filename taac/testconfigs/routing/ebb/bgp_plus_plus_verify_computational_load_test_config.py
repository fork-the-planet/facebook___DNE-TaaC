...
# pyre-unsafe
"""BGP_PLUS_PLUS_VERIFY_COMPUTATIONAL_LOAD_TEST_CONFIGS — EBB B17 TestConfig.

Built from the centralized
`test_config_to_verify_computational_load_of_bgp_plus_plus` factory.
"""
...
BGP_PLUS_PLUS_VERIFY_COMPUTATIONAL_LOAD_TEST_CONFIG = (
    test_config_to_verify_computational_load_of_bgp_plus_plus(
        test_config_name="BGP_PLUS_PLUS_VERIFY_COMPUTATIONAL_LOAD_TEST_CONFIGS",
