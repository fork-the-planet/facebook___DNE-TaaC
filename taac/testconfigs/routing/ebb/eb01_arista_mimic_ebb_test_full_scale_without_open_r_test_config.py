...
EB01_ARISTA_MIMIC_EBB_TEST_FULL_SCALE_WITHOUT_OPEN_R_TEST_CONFIG = (
    test_config_for_bgp_plus_plus_on_ebb_arista_with_bgp_mon(
        test_config_name="EB01-ARISTA_MIMIC_EBB_TEST_FULL_SCALE_WITHOUT_OPEN_R",
        host_driver_args={
            "eb01.lab.ash6": json.dumps(
                {"username": "admin", "password": _LAB_DEVICE_PASSWORD}
            ),
        },
        oss_mock_device_data={
            "eb01.lab.ash6": taac_types.MockDeviceInfo(
                name="eb01.lab.ash6",
        ...
        host_os_type_map={"eb01.lab.ash6": taac_types.DeviceOsType.ARISTA_FBOSS},
