...
# pyre-unsafe
"""NPI_51T_DVT_KO3_SSW_TEST_CONFIG — TestConfig.
...
NPI_51T_DVT_KO3_SSW_TEST_CONFIG = create_dctypef_npi_test_config(
    test_config_name="NPI_51T_DVT_TEST_CONFIG_KO3_SSW",
    device_name="ssw003.s001.m001.qzr1",
    local_mac_address="ce:6a:33:ed:b7:16",
    ixia_downlink_interface="eth1/62/1",
