...
# pyre-unsafe
"""OPTICS_NPI_FSW_KODIAK3_SSW_MINIPACK3 — CICD_TC TestConfig.
...
OPTICS_NPI_FSW_KODIAK3_SSW_MINIPACK3_TEST_CONFIG = create_optics_npi_test_config(
    test_config_name="OPTICS_NPI_FSW_KODIAK3_SSW_MINIPACK3_TEST_CONFIGS",
    dut_device_name="fsw003.p002.m001.qzr1",
