...
# pyre-unsafe
"""FBOSS_51T_BGP_HARDENING_KO3_SSW — Non-CICD residue TestConfig.
...
FBOSS_51T_BGP_HARDENING_KO3_SSW_TEST_CONFIG = (
    test_config_for_bgp_and_fboss_platform_hardening_in_conveyor(
        test_config_name="FBOSS_51T_BGP_HARDENING_KO3_SSW",
        device_name="ssw003.s001.m001.qzr1",
        local_mac_address="cc:6a:33:ed:b7:16",
