...
# pyre-unsafe
"""FBOSS_BGP_HARDENING_KODIAK3_XSW — CICD_TC TestConfig.
...
FBOSS_BGP_HARDENING_KODIAK3_XSW_TEST_CONFIG = (
    test_config_for_2_ixia_bgp_and_fboss_platform_hardening_in_conveyor(
        test_config_name="FBOSS_BGP_HARDENING_KODIAK3_XSW",
        ...
        route_map_rogue_egress="PROPAGATE_XSW_SSW_OUT",  # Setting Same as uplink
        ...
        downlink_peer_count=10,
        uplink_peer_count=10,
        rogue_peer_count=10,
        ...
        good_ndp_entries_uplink=50,
        good_ndp_entries_downlink=50,
