...
# pyre-unsafe
"""NPI_51T_DVT_KO3_XSW_TEST_CONFIG — TestConfig.
...
NPI_51T_DVT_KO3_XSW_TEST_CONFIG = create_dctypef_npi_test_config(
    test_config_name="NPI_51T_DVT_TEST_CONFIG_KO3_XSW",
    device_name="xsw002.x001.qzr1",
    local_mac_address="CC:6A:33:ED:B7:10",
    ...
    peergroup_downlink_mimic_v6="PEERGROUP_XSW_FX_V6",
    peergroup_uplink_mimic_v4="PEERGROUP_XSW_MA_V4",
    peergroup_downlink_mimic_v4="PEERGROUP_XSW_FX_V4",
    ...
    route_map_downlink_ingress="PROPAGATE_XSW_FX_IN",
    route_map_downlink_egress="PROPAGATE_XSW_FX_OUT",
