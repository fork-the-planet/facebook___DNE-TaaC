...
# pyre-unsafe
"""CHRONOS_NODE_FSW_FUJI — CICD_TC TestConfig.
...
CHRONOS_NODE_FSW_FUJI_TEST_CONFIG = build_bgp_dc_test_config(
    test_config_name="CHRONOS_NODE_FSW_FUJI",
