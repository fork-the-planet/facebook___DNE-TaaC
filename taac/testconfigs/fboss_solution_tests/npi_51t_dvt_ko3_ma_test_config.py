...
# pyre-unsafe
"""NPI_51T_DVT_KO3_MA_TEST_CONFIG — TestConfig.
...
NPI_51T_DVT_KO3_MA_TEST_CONFIG = create_dctypef_npi_test_config(
    test_config_name="NPI_51T_DVT_TEST_CONFIG_KO3_MA",
    device_name="ma01-03.qzr1",
    local_mac_address="9C:38:18:F1:F2:7F",
