...
# pyre-unsafe
"""FBOSS_BGP_HARDENING_KODIAK3_RB001_01_QXT1 — CICD_TC TestConfig.
...
# Kodiak3 rb001-01.qxt1 - BGP + Platform Hardening with Agent Warmboot
FBOSS_BGP_HARDENING_KODIAK3_RB001_01_QXT1_TEST_CONFIG = (
    test_config_for_bgp_and_fboss_platform_hardening_in_conveyor(
        test_config_name="FBOSS_BGP_HARDENING_KODIAK3_RB001_01_QXT1",
