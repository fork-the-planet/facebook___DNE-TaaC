...
# pyre-unsafe
"""NPI_48V_KODIAK3_TEST_CONFIGS — TestConfig (dead-code preservation).
...
NPI_48V_KODIAK3_TEST_CONFIG = (
    test_config_for_bgp_and_fboss_platform_hardening_in_conveyor(
        test_config_name="NPI_48V_KODIAK3_TEST_CONFIGS",
        device_name="fsw003.p003.m001.qzr1",
